// Создание кода T4 для модели "C:\Учеба 2\Инструментальные средства разработки программного обеспечения\Задание NBA\ScriptForBaceNetFramework\ScriptForBaceNetFramework\Entity\NBA.edmx" включено. 
